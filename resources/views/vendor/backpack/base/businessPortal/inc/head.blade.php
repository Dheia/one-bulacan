    @php
        $photo = Auth::guard('business-portal')->user()->businessOwner->image;
        $avatar = $photo;
    @endphp
    <meta charset="utf-8">
    ...
    <title>{{ isset($title) ? $title.' :: '.config('backpack.base.project_name') : config('backpack.base.project_name') . 'One Portal' }}</title>
