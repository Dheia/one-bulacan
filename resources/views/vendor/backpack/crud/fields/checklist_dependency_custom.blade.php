...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="container-fluid" style="padding: 0 20px;">
      ...
      @foreach ($primary_dependency['model']::all() as $connected_entity_entry)
          <div class="col-sm-{{ isset($primary_dependency['number_columns']) ? intval(12/$primary_dependency['number_columns']) : '4'}}" style="padding-left: 30px;">
              <div class="checkbox">
      ...
      <div class="row">
          ...
          @foreach ($secondary_dependency['model']::orderBy('page_name')->get() as $connected_entity_entry)

              @if($category !== $connected_entity_entry->page_name)
                <div class="col-md-12" style="padding-left: 30px;">
                  <br>
                  <label for="">{{ Str::title(Str::slug($connected_entity_entry->page_name, ' ')) }}</label>
                </div>
                @php 
                  $category = $connected_entity_entry->page_name;
                @endphp
              @endif

              <div class="col-sm-{{ isset($secondary_dependency['number_columns']) ? intval(12/$secondary_dependency['number_columns']) : '4'}}" style="padding-left: 40px;">
                  <div class="checkbox">
                      <label class="font-weight-normal">
                      <input type="checkbox"
