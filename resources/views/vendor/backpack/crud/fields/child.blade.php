            ...
            <tbody class="table-striped items sortableOptions">
                ...
                <tr class="array-row clonable" style="display: none;">
                    ...
                    <td>
                        ...
                        @if(view()->exists('vendor.backpack.crud.fields.'.$label['type']))
                            @include('vendor.backpack.crud.fields.'.$label['type'], array('field' => $label))
                        @else
                            @include('crud::fields.'.$label['type'], array('field' => $label))
                        @endif
                    </td>
                    @endforeach
                    <td>
