                            ...
                            <div class="section_wrapper mcb-section-inner">
                                ...
                                <div class="wrap mcb-wrap one valign-top move-up clearfix">
                                    <div class="mcb-wrap-inner">
                                            ...
                                            <div class="column_attr clearfix">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="header" style="padding: 20px; color: #FFF;">
                                                        ...
                                                        <a href="{{ route('show_business', ['category_slug' => $business->category_slug, 'slug' => $business->slug]) }}">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-right text-brown" style="text-align: right !important; color: #532f17 !important;
                                                                                ...
                                                                                padding-top: 3px !important;
                                                                                padding-bottom: 3px !important;">
                                                                                    <b> {{ $paynamicsPayment->pay_reference }} </b>
                                                                            </td>
                                                                        </tr>
                                                                        <!-- AMOUNT -->
                                                                        <tr>
                                        ...
                                        <div class="column mcb-column one column_column aligncenter">
                                            <a class="btn-yellow" href="{{ url($business->slug . '/online-payment') }}">
                                                <span class="button_label">Go back</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
