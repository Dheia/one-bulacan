@extends('v2.layouts.businesses_layout')
                            ...
                            @foreach($businesses as $business)
                                <div class="section mcb-section " style="padding-top:0px; padding-bottom:0px">
                                    <div class="section_wrapper mcb-section-inner">
                                        <div class="wrap mcb-wrap one valign-top clearfix search-results">
                                            <div class="mcb-wrap-inner">
                                                <div class="column one-fourth" style="padding-top: 20px;">
                                                    <div class="image_wrapper">
                                                        <a href="{{ url($selected_category ? $selected_category->slug.'/'.$business->slug : $business->slug.'?category_id='.$business->category_id) }}">                                                
                        ...
                        @else
                            <div class="section mcb-section " style="padding-top:0px; padding-bottom:0px">
                                <div class="section_wrapper mcb-section-inner">
                                    <div class="wrap mcb-wrap one valign-top clearfix search-results">
                                        <div class="mcb-wrap-inner">
                                             <div class="column mcb-column one column_column column-margin-5px aligncenter">
                                                No Business Found.
                                             </div>                                    
                                        </div>
                                    </div>
                                            ...
                                            @foreach($featured_businesses as $featured_business)
                                                @if($featured_business)
                                                    ...
                                                    <li class="post " style="margin-right=0;">
                                                        <a href="{{ asset($selected_category ? $selected_category->slug.'/'.$featured_business->slug : $featured_business->slug) }}" style="margin-right=0;">
                                                            <h5><b>{{$featured_business->name}}</b></h5>
                                                        </a>
                                                        <span class="date">
                                                            <i class="icon-location"></i>
                                                            {{$featured_business->address1}}, {{$featured_business->baranggay_name}}, {{$featured_business->location_name}}
                                                        </span>
                                                        <br>
                                                        <span class="date">
                                                            <i class="icon-mobile"></i>
                                                            {{$featured_business->mobile}}
                                                        </span>
                                                    </li>
                                                @endif
                                            @endforeach
