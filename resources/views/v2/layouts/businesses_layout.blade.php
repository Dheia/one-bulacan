...
<head>
    ...
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    <title>{{$selected_category->name}} - One {{ Config('settings.province') ?? "Project One"}}</title>

    <meta name="description" content="Here is a list of {!!$selected_category->name!!} related businesses in {{ Config('settings.province') }}. Find the best of {{ Config('settings.province') }}'s local businesses here.">
    <meta name="keywords" content="{!!$meta_keyword!!}">
    <meta name="author" content="">
    <meta property="og:url" content="{{ env('APP_URL') }}" />
    <meta property="og:description" content="Here is a list of {!!$selected_category->name!!} related businesses in {{ Config('settings.province') }}. Find the best of {{ Config('settings.province') }}'s local businesses here.">
    <meta property="og:image" content="{{asset('v2/content/one/images/OnePampangaCover.png')}}">

    <meta name="twitter:title" content="{!!$selected_category->name!!} - One {{ Config('settings.province') }}">
    <meta name="twitter:description" content="Here is a list of {!!$selected_category->name!!} related businesses in {{ Config('settings.province') }}. Find the best of {{ Config('settings.province') }}'s local businesses here.">
