...
return [
    ...
    */
    ...
    'default_datetime_format' => 'MMMM DD, YYYY - hh:mm A',
    ...
    'styles' => [
        ...
        'https://unpkg.com/@coreui/icons/css/all.min.css',

        'css/custom_backpack.css'
    ],
    ...
    'developer_name' => 'Tigernet Hosting and IT Services',
    ...
    */
    ...
    'setup_password_recovery_routes' => env('BACKPACK_RECOVER_PASSWORD_OPEN', env('APP_ENV') === 'local'),
    ...
    */
    ...
    'route_prefix' => 'admin-one',
    'portal_route_prefix' => 'one-portal',
